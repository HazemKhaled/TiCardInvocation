...
Handle<Value> ReplaceWithModuleName::startup() {
	...
	obj->Set(String::New("example"),
			FunctionTemplate::New(ReplaceWithModuleName::Example));
	obj->SetAccessor(String::New("exampleProp"),
			ReplaceWithModuleName::GetProperty,
			ReplaceWithModuleName::SetProperty);
